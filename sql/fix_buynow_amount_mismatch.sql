-- Fix BuyNow stored procedure to handle amount mismatch with tolerance for float rounding
-- The error shows: "amount_mismatch" - need to add tolerance for decimal precision
...
-- Recreate BuyNow with amount tolerance
...
-- Test the procedure
SELECT 'BuyNow procedure fixed - added amount tolerance for float rounding' as message;
